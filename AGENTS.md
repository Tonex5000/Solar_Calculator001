...
- **AI-frontend:** Vite + React 19 chat (`AI-frontend/src/components/Chat.jsx`) → POST to hardcoded `API_URL` (deployed Render backend) `/chat`, shows `intent`/`intent_label`/`data` in a debug toggle.
